...
class EventForm(forms.ModelForm):
    ...
    class Meta:
        model = Event
        #fields = {'name', 'event_date', 'venue', 'description', 'attends'}
        # or
        exclude = ['manager']  # accept manager display remaining fields
        labels = {
            'name': '',
            'event_date': '',
            'venue': '',
        ...
        widgets = {
            'name': forms.TextInput(attrs={'class': "form-control", 'placeholder': "Event Name"}),
            'event_date': forms.SelectDateWidget(attrs={'class': "form-control", 'placeholder': "Event Date"}),
            'venue': forms.Select(attrs={'class': "form-select", 'placeholder': "Venue", 'default': True}),
            'description': forms.Textarea(attrs={'class': "form-control", 'placeholder': "Description"}),
            'attends': forms.SelectMultiple(attrs={'class': "form-control", 'placeholder': "Attend"}),
        }
